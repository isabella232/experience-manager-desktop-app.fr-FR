...
* **Chargement des ressources plus performant :** configurez le [modèle de processus de mise à jour des ressources AEM pour qu’il soit transitoire](https://docs.adobe.com/content/help/fr-FR/experience-manager-65/assets/administer/performance-tuning-guidelines.html#Workflows).
