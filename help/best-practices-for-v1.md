...
* N’utilisez pas l’appli de bureau AEM pour faire migrer de grandes quantités de données d’une instance AEM vers une autre. See the [Migration Guide](https://docs.adobe.com/content/help/fr-FR/experience-manager-65/assets/administer/assets-migration-guide.html) to plan and execute asset migrations. En revanche, l’appli de bureau [prend en charge le téléchargement massif](use-app-v1.md#bulkupload) d’un grand nombre de ressources pour la première fois dans [!DNL Adobe Experience Manager].
