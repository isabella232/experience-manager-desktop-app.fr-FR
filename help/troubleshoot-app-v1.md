...
Lors du dépannage des performances sous-optimisées pour les utilisateurs individuels, passez en revue [les limites de l’application](#limitations). Les sections suivantes contiennent des suggestions pour améliorer les performances des utilisateurs individuels.
...
Si vous utilisez le Experience Manager sous Windows, vous pouvez configurer Windows pour améliorer les performances du client WebDAV. Pour plus d’informations, aller à [https://support.microsoft.com/fr-fr/kb/2445570](https://support.microsoft.com/fr-fr/kb/2445570).
